...
class Student(models.Model):
    ...
    enrolled_courses = models.ManyToManyField('course.Course', blank=True)  # Nếu bạn có mô hình Course
...
class Profile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, blank=True)  # Để xử lý cả User không phải sinh viên
